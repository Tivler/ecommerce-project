    ...
    <> 
        <footer className="footer">
            ...
            <div className="footer__socials">
                <a className="footer__socials__icon" href="https://www.linkedin.com/in/thomas-mckyer/"><FontAwesomeIcon className="footer__socials__icon--size" icon={['fab' , 'linkedin']} /><span className="footer__socials__label">LinkedIn</span></a>
                <a className="footer__socials__icon divider" href="https://www.instagram.com/tmckyer/"><FontAwesomeIcon className="footer__socials__icon--size" icon={['fab' , 'instagram']} /><span className="footer__socials__label">Instagram</span></a>
                <a className="footer__socials__icon" href="https://github.com/tivler"><FontAwesomeIcon className="footer__socials__icon--size" icon={['fab' , 'github-square']} /><span className="footer__socials__label">Github</span></a>
            </div>
